...
- The current fixed-condition input does not contain a `fault_number` × `Rs=Cs` sweep. Generate it separately with `make sim_DynamicSpareSharing`; that workflow now creates repair-rate, absolute-gain, and relative-gain heatmaps.
