...
public:
    ...
    bool loadFaults(string filename) {
        ...
        bool printallFaults = false;
        bool printFaultMap = false;
        if (printallFaults){
    ...
    void pivotClassify(){
        ...
        bool printPivot = false;
        bool printNonPivot = false;
        if (printPivot){
            cout << endl;
    ...
    void solve() {
        ...
        bool printAllFaultMatrix = false;
        ...
        for (int lu = 0; lu < LU_num; ++lu)
        {
            for (int ly = 0; ly < Layer_num; ++ly)
            {
                for (int bk = 0; bk < Bank_num; ++bk)
                {
                    ...
                    {
                        cout << "No valid solutions found in LU " << lu << " Layer " << ly << " Bank " << bk << endl;
                    }
                    else
                    {
                        cout << "Valid solutions exist in LU " << lu << " Layer " << ly << " Bank " << bk << endl;
                    }
                }
            }
        }
