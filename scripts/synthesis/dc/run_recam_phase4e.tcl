...
source [file join $repo_root scripts synthesis dc recam_phase4e_sources.tcl]
analyze -format sverilog $recam_phase4e_sources
elaborate $design
...
source [file join $repo_root scripts synthesis dc recam_phase3j_constraints.tcl]
...
# Sequential count/area are recorded by report_qor and gate_count.rpt.  This
# DC release does not support report_cell's hierarchy/filter options.
