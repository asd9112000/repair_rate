...
module sharing_controller #(
    ...
    wire [4*SPARE_WIDTH-1:0] unused_borrowed_rows_by_sa;
    wire [4*SPARE_WIDTH-1:0] unused_borrowed_cols_by_sa;
    ...
    resource_tracker #(
        ...
        .demands_rows_i(demands_rows_i),
        .demands_cols_i(demands_cols_i),
        .allocation_success_o(feasible_o),
        .borrowed_rows_o(borrowed_rows_o),
        .borrowed_cols_o(borrowed_cols_o),
        .borrowed_rows_by_sa_o(unused_borrowed_rows_by_sa),
        .borrowed_cols_by_sa_o(unused_borrowed_cols_by_sa),
