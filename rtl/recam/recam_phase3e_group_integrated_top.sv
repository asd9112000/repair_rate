...
// Phase 3E primary measurement boundary: Phase 3C plus GROUP only.
module recam_phase3e_group_integrated_top #(
    ...
    output wire busy_o, done_o, group_solution_valid_o,
    ...
    output wire [1:0] selected_score_o,
    // Retained Phase 3C observability makes the analyzer timing boundary
    // comparable to the accepted Phase 3C and Phase 3D integrated reports.
    ...
    recam_group_compressed_solution_selector group_selector (
        .sa_role_i(sa_role_i), .config_pattern_map_i(config_pattern_map),
        .group_solution_valid_o(group_solution_valid_o), .selected_map_index_o(selected_map_index_o),
        .selected_config_id_o(selected_config_id_o), .selected_pattern_id_o(selected_pattern_id_o),
        .selected_candidate_valid_o(selected_candidate_valid_o),
        .selected_repairable_o(selected_repairable_o), .selected_score_o(selected_score_o)
    );
endmodule
